...
def initialize_robots(arena_size=-1, particle_box=-1): # particle_box: size of the robot enclosed in a square
    ...
    robots = []
    robots.append(robot_braitenberg_avoider.Robot_player(4, y_center, 0, name="Avoider", team="A"))
    robots.append(robot_braitenberg_loveWall.Robot_player(20, y_center, 0, name="LoveWall", team="A"))
    robots.append(robot_braitenberg_hateWall.Robot_player(36, y_center, 0, name="HateWall", team="A"))
    robots.append(robot_braitenberg_loveBot.Robot_player(52, y_center, 0, name="LoveBot", team="A"))
    robots.append(robot_braitenberg_hateBot.Robot_player(68, y_center, 0, name="HateBot", team="A"))
    return robots
