...
def initialize_robots(arena_size=-1, particle_box=-1): # particle_box: size of the robot enclosed in a square
    ...
    robots = []
    robots.append(robot_subsomption.Robot_player(4, y_center, 0, name="Chasseur", team="A"))    # Gauche
    robots.append(robot_wanderer.Robot_player(93, y_center, 180, name="Proie", team="B"))  # Droite, comportement wanderer qui navigue bien
    return robots
